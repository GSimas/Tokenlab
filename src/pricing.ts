...
const LEGACY = {
  pt: "Modelo legado. O provedor não publica preço por token dos modelos atuais.",
  en: "Legacy model. The provider does not publish per-token pricing for current models.",
};
...
export const PRICING: PriceEntry[] = [
  // ---------------------------------------------------------------- OpenAI
  { id: "openai/gpt-5.6-sol", provider: "OpenAI", name: "gpt-5.6-sol", input: 4, output: 20, kind: "chat" },
  ...
  { id: "openai/gpt-5.5", provider: "OpenAI", name: "gpt-5.5", input: 5, output: 30, kind: "chat" },
  ...
  { id: "anthropic/claude-opus-4-1", provider: "Anthropic", name: "Claude Opus 4.1", input: 15, output: 75, kind: "chat" },
  ...
  { id: "anthropic/claude-haiku-3-5", provider: "Anthropic", name: "Claude Haiku 3.5", input: 0.8, output: 4, kind: "chat" },
  ...
  { id: "google/gemini-embedding-001", provider: "Google", name: "Gemini Embedding", input: 0.15, output: null, kind: "embedding" },
  ...
  { id: "deepseek/v4-flash", provider: "DeepSeek", name: "deepseek-v4-flash", input: 0.22, output: 0.66, kind: "chat", note: OFF_PEAK },

  // -------------------------------------------------------- Alibaba (Qwen)
  { id: "alibaba/qwen3.8-max", provider: "Alibaba", name: "Qwen3.8 Max", input: 2, output: 6, kind: "chat" },
  { id: "alibaba/qwen3.7-max", provider: "Alibaba", name: "Qwen3.7 Max", input: 1.25, output: 3.75, kind: "chat" },
  ...
  { id: "zai/glm-5.3-flash", provider: "Z.ai", name: "GLM-5.3-Flash", input: 0.075, output: 0.25, kind: "chat", note: PROMO },
  ...
  { id: "groq/qwen-3.8-27b", provider: "Groq", name: "Qwen 3.8-27B", input: 0.8, output: 4, kind: "chat" },
  { id: "groq/qwen-3.6-27b", provider: "Groq", name: "Qwen 3.6-27B", input: 0.6, output: 3, kind: "chat" },
  ...
  // ----------------------------------------------------------- Perplexity
  { id: "perplexity/sonar-pro", provider: "Perplexity", name: "Sonar Pro", input: 3, output: 15, kind: "chat", note: SEARCH_FEE },
  { id: "perplexity/sonar-reasoning-pro", provider: "Perplexity", name: "Sonar Reasoning Pro", input: 2, output: 8, kind: "chat", note: SEARCH_FEE },
  { id: "perplexity/sonar-deep-research", provider: "Perplexity", name: "Sonar Deep Research", input: 2, output: 8, kind: "chat", note: SEARCH_FEE },
  { id: "perplexity/sonar", provider: "Perplexity", name: "Sonar", input: 1, output: 1, kind: "chat", note: SEARCH_FEE },
];
